...
static const TSSymbol ts_symbol_map[] = {
  ...
  [sym_concatenator] = sym_concatenator,
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  [STATE(0)] = {
    ...
    [sym_concatenator] = ACTIONS(1),
    [sym_comment] = ACTIONS(3),
  },
  [STATE(1)] = {
    [sym_source_file] = STATE(30),
    [sym_shelf] = STATE(2),
    [sym_node_name] = STATE(6),
    [sym__node] = STATE(2),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [36] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__node_repeat1, 2, 0, 0),
  [38] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__node_repeat1, 2, 0, 0), SHIFT_REPEAT(25),
  [41] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__node_repeat1, 2, 0, 0), SHIFT_REPEAT(24),
  ...
  [56] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_after_nodes, 3, 0, 0),
  [58] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_before_nodes, 3, 0, 0),
  [60] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_before_nodes_repeat1, 2, 0, 0),
  [62] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_before_nodes_repeat1, 2, 0, 0), SHIFT_REPEAT(23),
  ...
  [74] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_node_name, 1, 0, 0),
  [76] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_shelf, 2, 0, 0),
  [78] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__node, 3, 0, 0),
  [80] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__node, 2, 0, 0),
  [82] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__node, 4, 0, 0),
  [84] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__node, 5, 0, 0),
